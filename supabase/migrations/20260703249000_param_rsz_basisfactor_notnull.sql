-- ================================================================
-- T-041 HOTFIX: param_rsz.basisfactor_arbeider_pct NOT NULL
-- ================================================================
--
...
--   alter table public.param_rsz alter column basisfactor_arbeider_pct drop not null;
--   update public.param_rsz set basisfactor_arbeider_pct = null where status = 'bediende';
...
update public.param_rsz
    set basisfactor_arbeider_pct = 1.0000
    where status = 'bediende'
      and basisfactor_arbeider_pct is null;

alter table public.param_rsz
    alter column basisfactor_arbeider_pct set not null;
