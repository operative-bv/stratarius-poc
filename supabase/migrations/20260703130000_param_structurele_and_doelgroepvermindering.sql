...
create table public.param_structurele_vermindering (
    ...
    forfait numeric(18, 4) not null check (forfait >= 0),
    coefficient_a numeric(12, 8) not null check (coefficient_a between 0 and 1),
    coefficient_b numeric(12, 8) not null check (coefficient_b between 0 and 1),
...
create table public.param_doelgroepvermindering (
    ...
    geldig_tot date null,
    forfait numeric(18, 4) not null check (forfait >= 0),
    coefficient numeric(12, 8) not null check (coefficient between 0 and 2),
