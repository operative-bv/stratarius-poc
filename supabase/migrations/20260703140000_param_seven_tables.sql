...
create table public.param_arbeidsduur (
    ...
    gemiddelde_wekelijkse_uren numeric(6, 4) not null check (gemiddelde_wekelijkse_uren between 0 and 60),
...
create table public.param_vakantiegeld (
    ...
    geldig_van date not null,
    geldig_tot date null,
    enkel_pct numeric(6, 4) not null check (enkel_pct between 0 and 1),
    dubbel_pct numeric(6, 4) not null check (dubbel_pct between 0 and 1),
    bron_url text not null,
    bron_document text null,
    created_at timestamptz not null default now(),
    updated_at timestamptz not null default now(),
...
create table public.param_index (
    ...
    geldig_van date not null,
    geldig_tot date null,
    index_coefficient numeric(10, 6) not null check (index_coefficient between 0.5 and 2),
    drempel_bruto numeric(18, 4) not null check (drempel_bruto >= 0),
    bron_url text not null,
    bron_document text null,
    created_at timestamptz not null default now(),
    updated_at timestamptz not null default now(),
...
create table public.param_bijzondere_bijdragen (
    ...
    geldig_van date not null,
    geldig_tot date null,
    tarief numeric(6, 4) not null check (tarief between 0 and 1),
...
create table public.param_wagen_mobiliteit (
    ...
    minimumbijdrage numeric(18, 4) not null check (minimumbijdrage >= 0),
    vaa_coefficient numeric(12, 8) not null check (vaa_coefficient between 0 and 2),
    bron_url text not null,
    bron_document text null,
    created_at timestamptz not null default now(),
    updated_at timestamptz not null default now(),
