...
--
-- dim_legale_entiteit is tenant-scoped domain-data. FK owning_account_id
...
-- enforces that owning_account_id points at a TEAM account (not personal).
--
...
comment on column public.dim_legale_entiteit.owning_account_id is
...
create index dim_legale_entiteit_owning_account_idx
    on public.dim_legale_entiteit (owning_account_id);
